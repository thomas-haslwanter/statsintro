...
The concept of \acrfull{dof} (DOF)\index{general}{DOF, degrees of freedom}, which in mechanics seems to be crystal clear, is harder to grasp for statistical applications.
