...
\begin{description}
  \item[QQ-Plots] \index{general}{plots!qq-plot}"Q" stands for \emph{quantile}. The quantiles of a given data set are plotted against the quantiles of a reference distribution, typically the standard normal distribution.
