...
The \gls{sd_} \index{general}{standard deviation} is the square root of the variance, and the
"sample standard deviation"\index{general}{sample standard deviation} the square root of the "sample variance":
