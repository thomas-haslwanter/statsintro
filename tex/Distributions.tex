...
When determining estimating the parameters that characterize a groupd of people, e.g. the weight of male Europeans, we can typically never measure all of them. In many cases, the function describing the distribution of the parameter under investigation is a smooth, continuous distribution function.
...
estimate the properties of the population from this sample. Thereby we assume that this sample is drawn randomly from the group, without any bias in the characteristics of our subjects.
