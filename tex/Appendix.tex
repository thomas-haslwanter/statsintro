...
\lstinputlisting[label=py:gettingStartedIpy,caption=gettingStartedIpy.py, language=Python]{../Code3/gettingStartedIpy.py}
...
\clearpage
\lstinputlisting[label=py:multipleRegression,caption=mult\_regress.py, language=Python]{../Code3/multipleRegression.py}

\clearpage
\lstinputlisting[label=py:linRegModel,caption=linRegModel.py, language=Python]{../Code3/linRegModel.py}
...
\clearpage
\lstinputlisting[label=py:bayesianStats,caption=bayesianStats.py, language=Python]{../Code3/bayesianStats.py}

\clearpage
\lstinputlisting[label=py:lifelinesDemo,caption=lifelinesDemo.py, language=Python]{../Code3/lifelinesDemo.py}
