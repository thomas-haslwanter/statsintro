...
df.plot('Tobacco', 'Alcohol', style='o', markersize=10)
plt.ylabel('Alcohol')
plt.title('Sales in Several UK Regions')
plt.ylim([3.8, 6.7])

outDir = r'C:\Users\p20529\Documents\Teaching\Master_FH\Stats\Images'
outFile = os.path.join(outDir, 'Alc_vs_Tobacco.png')
...
plt.savefig(fullOutFile, dpi=200)
print('Figure saved to {0}\n{1}'.format(outDir, outFile))
